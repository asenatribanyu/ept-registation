...
class Registrationalumni extends RestController
{
    public function __construct()
    {
        ...
        $this->load->model(
            array(
                'peserta/peserta_modelalumni',
                'registrant/registrant_modelalumni'
            )
        );
    ...
    public function index()
    {
        ...
        $this->load->view('registeralumni', $data);
    }
    ...
    public function save_post()
    {
        ...
        $data_event = $this->post('id_event_alumni');
        $this->peserta_modelalumni->insert($data, $data_event);
