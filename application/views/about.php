                            ...
                            <form id="contact" action="" method="post">
                                <div class="row">
                                    ...
                                    <div class="row" id="view_page">
                                        ...
                                        <div class="col-lg-12">
                                            <br>
                                            <h6>Sejarah Lembaga Bahasa Universitas Widyatama</h6>
                                            <br>1. Berdasarkan SK Rektor Universitas Widyatama No.121/SK/D.01/REKTOR-UTAMA/XI/2020, Nomenklatur Pusat Bahasa menjadi Lembaga Bahasa &nbsp;&nbsp;&nbsp;Universitas Widyatama. Kepala Lembaga Bahasa Periode 2020-2024 Ibu Hj. Ida Zuraida, S.S., M.Pd.
                                            <div class="col-lg-2">
                                                <img src="<?php echo base_url(); ?>assets/images/Picture6.jpg">
                                            </div>
                                            <br>2. Kepala Pusat Bahasa periode 2017-2020 Bapak Heri Heryono, M.Hum.
                                            <div class="col-lg-2">
                                                <img src="<?php echo base_url(); ?>assets/images/Picture5.jpg">
                                            </div>
                                            <br>3. Bapak DR. H. Hendar, M.Pd. menjabat sebagai plt Kepala Pusat Bahasa.
                                            <div class="col-lg-2">
                                                <img src="<?php echo base_url(); ?>assets/images/Picture4.png">
                                            </div>
                                            <br>4. Ditetapkan menjadi Pusat Bahasa pada tahun 2016 yang dikepalai oleh Bapak Alvii Bungaran Siregar, M.A.
                                            <div class="col-lg-2">
                                                <img src="<?php echo base_url(); ?>assets/images/Picture3.jpg">
                                            </div>
                                            <br>5. Berkembang kemudian menjadi Self-Accessed Center (SAC) dikepalai oleh Ibu Meita Lukitawaty Sujatna, M. Hum.
                                            <div class="col-lg-2">
                                                <img src="<?php echo base_url(); ?>assets/images/Picture2.png">
                                            </div>
                                            <br>6. Berawal dari English Proficiency Team yang dikepalai oleh Ibu Dra. Maria Yosephine Widarti, M.Pd. pada tahun 2010.
                                            <div class="col-lg-2">
                                                <img src="<?php echo base_url(); ?>assets/images/Picture1.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
