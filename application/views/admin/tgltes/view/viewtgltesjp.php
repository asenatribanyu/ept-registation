        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 text-center mx-auto">
                    <h1 class="text-white pt-3 mt-n5">Data Tanggal JLPT</h1>
...
<div class="card card-body blur shadow-blur mx-2 mx-md-3 mt-n6">
    ...
    <?php echo anchor('admin/tanggal/Tanggal_JLPT/input', '<button class="btn btn-sm btn-primary mb-3"><i class="fas fa-plus fa-sm"> Tambah Tanggal Tes</i></button>') ?>
    <form method="post" action="<?php echo base_url('admin/tanggal/Tanggal_JLPT/deletee') ?>" id="form-delete">
            ...
            <table class="table table-bordered table-striped table-hover" id="dataTable1" style="width:100%">
                ...
                <tbody>
                    ...
                    foreach ($tbl_event_jp as $e) : ?>
                        <tr style="text-align: center;">
                            <td><input type='checkbox' class='check-item' name='id_event_jp[]' value='<?php echo $e->id_event_jp ?>'></td>
                            <td><?php echo $no++ ?></td>
                            ...
                            <td style="text-align: center;">
                                <a href="<?php echo base_url(); ?>admin/tanggal/Tanggal_JLPT/update/<?php echo $e->id_event_jp; ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url(); ?>admin/tanggal/Tanggal_JLPT/delete/<?php echo $e->id_event_jp; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
