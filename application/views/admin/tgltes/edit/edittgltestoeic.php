...
<div class="card card-body blur shadow-blur mx-2 mx-md-3 mt-n6">
    <div class="container-fluid">
        <?php foreach ($tbl_event_toeic as $e) : ?>
            <?php echo form_open_multipart('admin/tanggal/tanggaltoeic/update_aksi') ?>
            <label>Tanggal Tes</label>
            <div class="input-group input-group-outline mb-3">
                <input type="hidden" name="id_event_toeic" class="form-control border border-primary" value="<?php echo $e->id_event_toeic ?>">
