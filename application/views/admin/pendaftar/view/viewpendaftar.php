...
<div class="card card-body blur shadow-blur mx-2 mx-md-3 mt-n6">
	<div class="row" style="justify-content: flex-end;">
		<div class="col-md-3">
			<!-- Fitur Search -->
			<form action="<?= base_url('admin/pendaftar/pendaftar/index'); ?>" method="post">
				<div class="input-group mb-3 gap-2">
					<input type="text" class="form-control p-2" style="border: 1px solid #808080; height: 40px; border-radius: 5px;" placeholder="Search" name="search" autocomplete="off" >
