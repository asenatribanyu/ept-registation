...
<div class="card card-body blur shadow-blur mx-2 mx-md-3 mt-n6">
    <div class="container-fluid">
        <?php foreach ($tbl_peserta_toeic as $p) : ?>
            <?php echo form_open_multipart('admin/peserta/pesertatoeic/update_aksi') ?>
            <label>Nama Peserta</label>
            <div class="input-group input-group-outline mb-3">
                <input type="hidden" name="id_peserta_toeic" class="form-control border border-primary" value="<?php echo $p->id_peserta_toeic ?>">
