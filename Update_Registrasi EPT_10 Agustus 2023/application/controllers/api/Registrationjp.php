...
class Registrationjp extends RestController
{
    public function __construct()
    {
        ...
        $this->load->model(
            array(
                'peserta/peserta_modeljp',
                'registrant/registrant_modeljp'
            )
        );
    ...
    public function index()
    {
        ...
        $this->load->view('registerjp', $data);
    }
    ...
    public function save_post()
    {
        ...
        $data_event = $this->post('id_event_jp');
        $this->peserta_modeljp->insert($data, $data_event);
        ...
        $subject = "Anda telah terdaftar dalam test JLPT Widyatama";
        ...
        <head>
            ...
            <title>Registration - JLPT Widyatama</title>
            <style type="text/css">
                #outlook a {
                    padding: 0;
                }
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" style="padding:0;Margin:0;padding-top:10px; padding-bottom:10px">
                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;line-height:24px;color:#333333;font-size:16px">
                                                                                Hi, ' . $name . ' Your reservation for JLPT Widyatama has been successfully confirmed. The details for your JLPT Widyatama test schedule are listed below:
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
