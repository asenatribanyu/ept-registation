        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 text-center mx-auto">
                    ...
                    <p class="lead text-white mt-3">Tabel Score TOEIC</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="card card-body blur shadow-blur mx-2 mx-md-3 mt-n6">
    ...
    <?php echo anchor('admin/scoretoeic/create', '<button class="btn btn-sm btn-primary mb-3"><i class="fa fa-upload"> Import</i></button>') ?>

    <form method="post" action="<?php echo base_url('admin/scoretoeic/deletee') ?>" id="form-delete">
        <div class="data-tables datatable-dark">
            <table class="table table-bordered table-striped table-hover" id="dataTable1" style="width:100%">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    foreach ($tbl_score_toeic as $s) : ?>
                        <tr style="text-align: center;">
                            <td><input type='checkbox' class='check-item' name='id_score_toeic[]' value='<?php echo $s->id_score_toeic ?>'></td>
                            ...
                            <td style="text-align: center;">
                                <a href="<?php echo base_url(); ?>admin/scoretoeic/delete/<?php echo $s->id_score_toeic; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
