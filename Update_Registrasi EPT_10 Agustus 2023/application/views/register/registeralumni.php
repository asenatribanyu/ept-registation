...
<head>
    ...
    <title>ALUMNI | Lembaga Bahasa Widyatama</title>
...
<body onload="load()" style="background-color: #0000">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <b>Peserta alumni ini untuk mahasiswa Universitas Widyatama, Alumni atau Umum
                                                </div>
                                ...
                                <input type="hidden" id="id_event_alumni" name="id_event_alumni" value="<?= (isset($event)) ? $event->id_event_alumni : ''; ?>">
    ...
    <script src="<?php echo base_url(); ?>/assets/custom/js/bookingalumni.js" type="text/javascript"></script>
