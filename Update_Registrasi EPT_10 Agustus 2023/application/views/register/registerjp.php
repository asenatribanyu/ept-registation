...
<body onload="load()" style="background-color: #0000">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group m-form__group">
                                    <label for="nama">NPM/NIK/NISN<span class="text-danger">*</span></label>

                                    <input type="text" class="form-control form-control-user" placeholder="Masukkan NPM/NIK/NISN" id="npm" name="npm" required="">
                                    <p style="color:gray;font-size:13px;">*ket : Civitas diisikan NPM, Public diisikan NIK/NISN</p>
                                </div>
                            ...
                            <div class="col-lg-6">
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <b>Peserta JLPT ini untuk mahasiswa Universitas Widyatama, Alumni atau Umum dengan ketentuan : </b>
                                                    <br>
                                                    1. Pembayaran dilakukan di PUPD (Gedung Graha Widyatama Lt 1) dan dilanjutkan ke Bank OCBC NISP (Samping GSG Widyatama).
                                                    <br>
                                                    2. Bukti pembayaran yang dikeluarkan oleh PUPD wajib dibawa pada saat ujian.
                                                    <br>
                                                    3. </a>Peserta hanya bisa registrasi satu kali dan bukti pembayaran dari PUPD sesuai dengan tanggal test yang dipilih
                                                    <br>
                                                    4. Apabila peserta tidak dapat mengikuti test pada tanggal yang sudah dipilih, maka <b>pembayaran akan hangus dan tidak dapat melakukan penjadwalan ulang</b>
                                                    <br>
                                ...
                                <input type="hidden" id="id_event_jp" name="id_event_jp" value="<?= (isset($event)) ? $event->id_event_jp : ''; ?>">
    ...
    <script src="<?php echo base_url(); ?>/assets/custom/js/bookingjp.js" type="text/javascript"></script>
    ...
    <footer>
        <p class="copyright">Copyright &copy; <script>
            ...
            </script> — Lembaga Bahasa. All Rights Reserved</p>
        <br>
        <br>
        <p class="designed-by">
            Created by MBKM Team Widyatama 2022
        </p>
    </footer>
</body>
