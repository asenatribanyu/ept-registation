                                                                ...
                                                                <tr class="inner-box">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            <div class="text-center" class="primary-btn">
                                                                                <a style="border-radius:20px; width:80%;" class="btn btn-primary register" type="submit" href="<?php echo base_url(); ?>ALUMNI/registeralumni/<?= $ev->id_event_alumni; ?>" id="register" name="register">Register</a>
                                                                            </div>
                                                                        <?php
                                                                        } ?>
                                                                    </td>
                                                                    <td>
                                                                        <div class="text-center" class="event-wrap">
                                                                            <a href="<?php echo base_url(); ?>ALUMNI/detailalumni/<?= $ev->id_event_alumni; ?>" button type="button" class="btn btn-info">Detail</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                        <?php
